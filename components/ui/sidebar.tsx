...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: a flex child otherwise refuses to shrink below its
        // content's intrinsic width (the default min-width: auto), so a
        // page with a wide table/toolbar forces this whole flex column —
        // and the page around it — wider than the viewport instead of
        // scrolling only inside that content's own overflow-x-auto.
